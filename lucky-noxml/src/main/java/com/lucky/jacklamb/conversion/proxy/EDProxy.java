...
public class EDProxy extends Conversion {
    ...
    public static <T extends LuckyConversion> T getProxy(Class<T> childInterfaceClass){
        ...
        Class<? extends LuckyConversion>[] luckyConversionClasses=childInterfaceClass.getAnnotation(com.lucky.jacklamb.conversion.annotation.Conversion.class).value();
