...
public class IniKey {
	...
	public static final String REVERSE_PCKAGE="reversePackage";
	...
	public static final String CREATE_TABLE="createTables";
	
	public static final String POOLMETHOD="poolMethod";
