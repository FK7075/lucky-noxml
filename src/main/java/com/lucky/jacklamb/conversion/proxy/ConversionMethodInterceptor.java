 ...
 **/
public class ConversionMethodInterceptor implements MethodInterceptor {
    ...
    public List<EntityAndDto> getEntityAndDtoByConversion(Class<? extends LuckyConversion>[] conversionClasses){
        ...
        for(Class<? extends LuckyConversion> conversionClass:conversionClasses){
            ...
            eds.add(new EntityAndDto(luckyConversion,(Class<?>)interfacesTypes[0],(Class<?>)interfacesTypes[1]));
        }
        return eds;
    }
     ...
     * @throws IllegalAccessException
     */
    public Map<String,Object> getSourceNameValueMap(Object sourceObject, String initialName) throws IllegalAccessException {
     ...
     * @throws InstantiationException
     */
    public Object setTargetObject(Object targetObject, Map<String, Object> sourceMap, List<EntityAndDto> eds, boolean toDto, String initialName) throws IllegalAccessException, InstantiationException {
